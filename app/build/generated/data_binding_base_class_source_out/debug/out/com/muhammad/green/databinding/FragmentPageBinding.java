...
public final class FragmentPageBinding implements ViewBinding {
  ...
  private FragmentPageBinding(@NonNull LinearLayout rootView, @NonNull TextView lblPage) {
  ...
  public static FragmentPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.lbl_page;
      TextView lblPage = rootView.findViewById(id);
      if (lblPage == null) {
        break missingId;
      }

      return new FragmentPageBinding((LinearLayout) rootView, lblPage);
    }
