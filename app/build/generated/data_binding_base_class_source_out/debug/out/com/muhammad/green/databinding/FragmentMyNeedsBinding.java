...
public final class FragmentMyNeedsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentMyNeedsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMyNeedsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_my_needs, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMyNeedsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.myNeeds_rv;
      RecyclerView myNeedsRv = rootView.findViewById(id);
      if (myNeedsRv == null) {
        break missingId;
      }
