...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView, @NonNull TextView splashAppName,
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      TextView splashAppName = rootView.findViewById(id);
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, splashAppName, splashLogo);
    }
